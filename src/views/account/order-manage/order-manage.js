...
document.addEventListener("DOMContentLoaded", await function() {
        ...
        readyOption.classList.add("has-background-danger-light", "has-text-danger")
        readyOption.setAttribute("value", "상품 준비중")
        readyOption.textContent = "상품 준비중"
                // 배송중
        const shippingOption = document.createElement("option")
        shippingOption.classList.add("has-background-primary-light", "has-text-primary")
        ...
        completionOption.textContent = "배송완료"
                ...
                if(userStatusData==="배송완료"){
                    ...
                    select.classList.add("has-background-danger-light", "has-text-danger", "clickSelect")
                }else{
                    shippingOption.setAttribute("selected", "true")
                    select.classList.add("has-background-primary-light", "has-text-primary", "clickSelect")
                }
        ...
        wrapper.append(orderDate, orderProduct, orderAmount, selectWrapper, btnWrapper)
